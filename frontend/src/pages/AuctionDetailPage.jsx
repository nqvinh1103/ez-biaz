  ...
  useEffect(() => {
    ...
    conn.on("bid_placed", (payload) => {
      ...
      setAuction((prev) => {
        ...
        const nextCurrent = data.currentBid ?? data.CurrentBid ?? prev.currentBid;
              ...
              <div className="flex flex-1 flex-col gap-4">
                ...
                <div className="space-y-2">
                  <CountdownTimer
                    ...
                    secs={timer.secs}
                  />
                  <p className={`text-xs ${realtimeState === "connected" ? "text-emerald-600" : realtimeState === "connecting" ? "text-amber-600" : "text-[#737373]"}`}>
                    Realtime: {realtimeState === "connected" ? "Connected" : realtimeState === "connecting" ? "Reconnecting..." : "Offline"}
                  </p>
                </div>
